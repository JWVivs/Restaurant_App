...
# distmatrix_df[distmatrix_df == 0] <- NA

# may need to get df into a long format
...
# for now... pasting list of similar restaurant names into a column with the respective restaurant
