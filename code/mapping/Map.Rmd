...
```{r}
### Trying to assign city and state their own unique column
### for potential drop down menu selection in app

# library(stringr)
#df_combined$CityState <- str_extract(df_combined$Address, 'Boston, MA|Portland, ME')
